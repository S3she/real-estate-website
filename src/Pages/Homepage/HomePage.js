  ...
  const navStyle = {
   ...
   return (
     ...
     <div className='container'>
       ...
       <div className='hero-text'>Här skriver vi innehåll på första sidan som attraherar kunden till att kolla vidare och få en hemstadig känsla. Vi kan skriva lite vad som helst här inne, 
