...
function Services() {
  return (
    ...
    <div className="textOverall">     
      <h2 className="H2"> REAL ESTATE GOTHENBURG SERVICES</h2> 
    ...
    <div className="textSecond">
      ...
      <br />Marketing - We pride ourselves on being at the top of the curve when it comes to marketing and technology.
      We keep your listing top of mind and maximize the exposure of your home to agents and buyers.  
      We make sure the house is in immaculate condition and create a welcoming environment with refreshments, music and engaging conversation.
      We also make ourselves readily available for private showings.  

    <h3 className="H3">BUYING</h3>
